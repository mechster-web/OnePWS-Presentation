...
export const navigationJourneys: NavigationJourney[] = [
  {
    ...
    sequence: [
      ...
      ...projectCredentialsSequence,
      "why-onepws",
      "next-steps-closing",
      "logo-finale",
    ],
    optionalBranches: ["ergonomic-evidence", "technology-layer", "proof-layer"],
    memoryMoments: ["opening-cover", "complete-ecosystem", "incident-response", "project-portfolio", "next-steps-closing", "logo-finale"],
...
export const timeBasedRoutes = [
  ...
  { id: "complete-30", label: "30-minute complete experience", durationMs: 30 * 60_000, journeyId: "complete-story" },
];

export const navigationMapGroups: NavigationMapGroup[] = [
  { id: "opening", title: "Opening", description: "System awakening and journey entry.", chapterIds: ["opening-cover", "journey-roadmap"], position: { x: 10, y: 48 }, theme: "cinematic" },
