...
export function ClosingChapter({ chapter }: Props) {
  ...
  return (
    <article className="relative h-full w-full overflow-hidden bg-white text-control-text">
      ...
      <div className="pointer-events-none absolute right-[2vw] top-[12vh] h-[36vh] w-[38vw] rounded-full bg-control-warm/5 blur-[76px]" />
      ...
      <section className="absolute inset-x-[1.55vw] top-[9.65vh] bottom-[7.05vh] z-10">
        <div className="absolute inset-x-0 top-0 bottom-[10.2vh] grid grid-rows-[23vh_28vh_18.8vh] gap-[1.05vh]">
          <motion.section
            animate={{ opacity: 1, y: 0 }}
            className="grid min-h-0 grid-cols-[minmax(30rem,0.72fr)_minmax(0,1fr)] gap-[1.25vw]"
            initial={false}
          ...
          <motion.section
            animate={{ opacity: 1, y: 0 }}
            className="grid min-h-0 grid-cols-[minmax(32rem,0.54fr)_minmax(0,0.46fr)] gap-[1.05vw]"
            initial={false}
          ...
          >
            <section className="relative min-h-0 overflow-hidden rounded-[0.9rem] border border-slate-200/86 bg-white/72 shadow-[inset_0_1px_0_rgb(255_255_255/0.92),0_1rem_2.8rem_rgb(15_23_42/0.08)] backdrop-blur-[26px]">
              ...
              <div className="absolute bottom-[1.15vh] left-[1.1vw] right-[1.1vw] grid grid-cols-5 gap-[0.55vw]">
                {decisionReasons.map((reason) => (
                  <div className="rounded-[0.62rem] border border-white/78 bg-white/72 px-[0.62vw] py-[0.72vh] text-[clamp(0.48rem,0.56vw,0.66rem)] font-bold leading-[1.2] text-slate-800 shadow-sm backdrop-blur-[14px]" key={reason}>
                    {reason}
                  </div>
                ))}
              </div>
            ...
            <section className="min-h-0 overflow-hidden rounded-[0.9rem] border border-slate-200/86 bg-white/74 p-[0.9vw] shadow-[inset_0_1px_0_rgb(255_255_255/0.92),0_1rem_2.8rem_rgb(15_23_42/0.08)] backdrop-blur-[26px]">
              ...
              <div className="mt-[1vh] grid grid-cols-2 gap-[0.62vw]">
          ...
          >
            ...
            <section className="grid min-h-0 grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] overflow-hidden rounded-[0.9rem] border border-slate-200/86 bg-white/76 shadow-[inset_0_1px_0_rgb(255_255_255/0.92),0_1rem_2.5rem_rgb(15_23_42/0.08)] backdrop-blur-[26px]">
              ...
              <div className="grid content-center gap-[0.48vh] px-[1vw] py-[0.85vh]">
                {["Mission and workflows", "Room dimensions and site constraints", "Operator count and shift pattern", "Displays, applications and systems", "Timeline, stakeholders and approval path"].map((item) => (
                  <div className="flex items-center gap-2 text-[clamp(0.54rem,0.64vw,0.76rem)] font-bold text-slate-800" key={item}>
...
function ProcessStepCard({ step, index }: { step: NextStep; index: number }) {
  return (
    <article className="min-h-[7.15vh] rounded-[0.66rem] border border-slate-200/86 bg-white/68 px-[0.68vw] py-[0.65vh] shadow-[0_0.75rem_1.7rem_rgb(15_23_42/0.052)]">
