  ...
  return (
    <article className="relative grid h-full w-full place-items-center overflow-hidden bg-white">
      ...
      <motion.div
        ...
        className="absolute left-1/2 top-[31cqh] h-px w-[min(50cqw,48rem)] origin-center -translate-x-1/2 bg-[linear-gradient(90deg,transparent,#cbd5e1_18%,#e30613_50%,#cbd5e1_82%,transparent)]"
        initial={{ scaleX: 0, opacity: 0 }}
        transition={{ duration: 1.8, ease, delay: 0.15 }}
      />
      <motion.div
        animate={{ scaleX: 1, opacity: 0.72 }}
        className="absolute left-1/2 top-[68cqh] h-px w-[min(36cqw,34rem)] origin-center -translate-x-1/2 bg-[linear-gradient(90deg,transparent,#cbd5e1,transparent)]"
        initial={{ scaleX: 0, opacity: 0 }}
      ...
      >
        ...
        <img
          alt="OnePWS"
          className="relative h-auto w-[min(50cqw,48rem)] select-none object-contain drop-shadow-[0_1.35rem_3rem_rgb(15_23_42/0.12)]"
          draggable={false}
      ...
      <motion.p
        ...
        className="absolute bottom-[18cqh] text-center text-[0.9rem] font-semibold uppercase tracking-[0.42em] text-slate-500"
