...
const slidePlan = [
  ...
  ["project", "Project credentials", "Project Portfolio Overview", "Transport, smart city, energy, governance, public safety and international reAItion."],
  ...
  ["project", "Project credentials", "ACPO/APCO Ahmedabad And Shell Brunei", "Public safety reference and live-reAItion proof."],
